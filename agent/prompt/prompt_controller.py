...
HORIZONTAL_PROMPT_BASE = {
    "BREAKDOWN_NOTE_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'horizontal/base/base/breakdown_note.txt')),
    "OPENAI_SEEK_DATABASE_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'horizontal/base/base/openai_seek_database.md'), start=['//']),
    "GET_STOCK_CODE_AND_SUITABLE_ROW_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/get_stock_code_and_suitable_row.txt'), start=['//']),
    "BRANCH_REASONING_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/branch_reasoning.txt'), start=['//']),
    "REASONING_TEXT2SQL_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/reasoning_text2sql.txt'), start=['//']),
    "BRANCH_REASONING_TEXT2SQL_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/branch_reasoning_text2sql.txt'), start=['//']),
...
HORIZONTAL_PROMPT_UNIVERSAL = {
    "BREAKDOWN_NOTE_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'horizontal/base/universal/breakdown_note.txt')),
    "OPENAI_SEEK_DATABASE_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'horizontal/base/universal/openai_seek_database.md'), start=['//']),
    "GET_STOCK_CODE_AND_SUITABLE_ROW_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/get_stock_code_and_suitable_row.txt'), start=['//']),
    "BRANCH_REASONING_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/branch_reasoning.txt'), start=['//']),
    "REASONING_TEXT2SQL_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/reasoning_text2sql.txt'), start=['//']),
    "BRANCH_REASONING_TEXT2SQL_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/branch_reasoning_text2sql.txt'), start=['//']),
...
FIIN_HORIZONTAL_PROMPT_UNIVERSAL = {
    "BREAKDOWN_NOTE_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'horizontal/base/universal/breakdown_note_fiin.txt')),
    "OPENAI_SEEK_DATABASE_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'horizontal/base/universal/openai_seek_database_fiin.md'), start=['//']),
    "GET_STOCK_CODE_AND_SUITABLE_ROW_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/get_stock_code_and_suitable_row.txt'), start=['//']),
    "BRANCH_REASONING_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/branch_reasoning.txt'), start=['//']),
    "REASONING_TEXT2SQL_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/reasoning_text2sql.txt'), start=['//']),
    "BRANCH_REASONING_TEXT2SQL_PROMPT": utils.read_file_without_comments(os.path.join(current_dir, 'general/branch_reasoning_text2sql.txt'), start=['//']),
