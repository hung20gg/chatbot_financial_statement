...
def chat(user_name):
    ...
    text2sql_model = st.selectbox(
        "Text2SQL Model:",
        ['gemini-2.0-flash', 'qwen2.5-3b-sft', 'gpt-4o-mini', 'gpt-4o', 'gemini-2.0-flash-thinking-exp-01-21', 'gemini-2.0-pro-exp-02-05'],
        index=['gemini-2.0-flash', 'qwen2.5-3b-sft', 'gpt-4o-mini' , 'gpt-4o', 'gemini-2.0-flash-thinking-exp-01-21', 'gemini-2.0-pro-exp-02-05'].index(st.session_state.text2sql_model)
    )
